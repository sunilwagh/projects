...
public class Anuradha implements Nakshatra{
	...
	features.add("Researcher");					
		...
		features.add("Saddam Hussain had his moon/mars/ rahu in anuradha and on being asked why did he attack kuwait. he said ' when i get something in my head i act'");				
	}
