...
public class SahajBhavaHelper {

	public static String infoAboutLordOfBhava3InBhava1(Bhava3 bhava3,Bhava1 bhava1) {
	...
	public static String infoAboutLordOfBhava3InBhava2(Bhava3 bhava3,Bhava2 bhava2) {
		StringBuffer infoBuffer = new StringBuffer();
	...
	public static String infoAboutLordOfBhava3InBhava3(Bhava3 bhava3) {
		StringBuffer infoBuffer = new StringBuffer();
	...
	public static String infoAboutLordOfBhava3InBhava4(Bhava3 bhava3,Bhava4 bhava4) {
		StringBuffer infoBuffer = new StringBuffer();
	...
	public static String infoAboutLordOfBhava3InBhava5(Bhava3 bhava3,Bhava5 bhava5) {
		StringBuffer infoBuffer = new StringBuffer();
		infoBuffer.append("");
		return infoBuffer.toString();
	...
	public static String infoAboutLordOfBhava3InBhava6(Bhava3 bhava3,Bhava6 bhava6) {
		StringBuffer infoBuffer = new StringBuffer();
	...
	public static String infoAboutLordOfBhava3InBhava7(Bhava3 bhava3,Bhava7 bhava7) {
		StringBuffer infoBuffer = new StringBuffer();
	...
	public static String infoAboutLordOfBhava3InBhava8(Bhava3 bhava3,Bhava8 bhava8) {
		StringBuffer infoBuffer = new StringBuffer();
	...
	public static String infoAboutLordOfBhava3InBhava9(Bhava3 bhava3,Bhava9 bhava9) {
		StringBuffer infoBuffer = new StringBuffer();
	...
	public static String infoAboutLordOfBhava3InBhava10(Bhava3 bhava3,Bhava10 bhava10) {
		StringBuffer infoBuffer = new StringBuffer();
	...
	public static String infoAboutLordOfBhava3InBhava11(Bhava3 bhava3,Bhava11 bhava11) {
		StringBuffer infoBuffer = new StringBuffer();
	...
	public static String infoAboutLordOfBhava3InBhava12(Bhava3 bhava3,Bhava12 bhava12) {
		StringBuffer infoBuffer = new StringBuffer();
	...
	public static String AriesInBhava3() {
	...
	public static String TaurusInBhava3() {
	...
	public static String GeminiInBhava3() {
	...
	public static String CancerInBhava3() {
	...
	public static String LeoInBhava3() {
		StringBuffer taurusInBhava1 = new StringBuffer();
	...
	public static String VirgoInBhava3() {
		StringBuffer taurusInBhava1 = new StringBuffer();
	...
	public static String LibraInBhava3() {
		StringBuffer taurusInBhava1 = new StringBuffer();
	...
	public static String ScorpioInBhava3() {
		StringBuffer taurusInBhava1 = new StringBuffer();
	...
	public static String SagittariusInBhava3() {
		StringBuffer taurusInBhava1 = new StringBuffer();
	...
	public static String CapricornInBhava3() {
		StringBuffer taurusInBhava1 = new StringBuffer();
	...
	public static String AcquariusInBhava3() {
		StringBuffer taurusInBhava1 = new StringBuffer();
	...
	public static String PiscesInBhava3() {
		StringBuffer taurusInBhava1 = new StringBuffer();
