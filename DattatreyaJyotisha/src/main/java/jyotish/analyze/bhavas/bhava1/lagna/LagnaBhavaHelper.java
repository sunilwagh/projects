...
public class LagnaBhavaHelper {
	...
	public String infoAboutLordOfBhava1InBhava1(Bhava1 bhava1) {
	...
	public String infoAboutLordOfBhava1InBhava2(Bhava1 bhava1, Bhava2 bhava2) {
		StringBuffer infoBuffer = new StringBuffer();
	...
	public String infoAboutLordOfBhava1InBhava3(Bhava1 bhava1, Bhava3 bhava3) {
		StringBuffer infoBuffer = new StringBuffer();
		infoBuffer.append(
	...
	public String infoAboutLordOfBhava1InBhava4(Bhava1 bhava1, Bhava4 bhava4) {
		StringBuffer infoBuffer = new StringBuffer();
		infoBuffer.append(
	...
	public String infoAboutLordOfBhava1InBhava5(Bhava1 bhava1, Bhava5 bhava5) {
		StringBuffer infoBuffer = new StringBuffer();
	...
	public String infoAboutLordOfBhava1InBhava6(Bhava1 bhava1, Bhava6 bhava6) {
		StringBuffer infoBuffer = new StringBuffer();
		infoBuffer.append(
	...
	public String infoAboutLordOfBhava1InBhava7(Bhava1 bhava1, Bhava7 bhava7) {
		StringBuffer infoBuffer = new StringBuffer();
	...
	public String infoAboutLordOfBhava1InBhava8(Bhava1 bhava1, Bhava8 bhava8) {
		StringBuffer infoBuffer = new StringBuffer();
		infoBuffer.append(
	...
	public String infoAboutLordOfBhava1InBhava9(Bhava1 bhava1, Bhava9 bhava9) {
		StringBuffer infoBuffer = new StringBuffer();
		infoBuffer.append(
	...
	public String infoAboutLordOfBhava1InBhava10(Bhava1 bhava1, Bhava10 bhava10) {
		StringBuffer infoBuffer = new StringBuffer();
		infoBuffer.append("");
		return infoBuffer.toString();
	...
	public String infoAboutLordOfBhava1InBhava11(Bhava1 bhava1, Bhava11 bhava11) {
		StringBuffer infoBuffer = new StringBuffer();
		infoBuffer.append(
	...
	public String infoAboutLordOfBhava1InBhava12(Bhava1 bhava1, Bhava12 bhava12) {
		StringBuffer infoBuffer = new StringBuffer();
		infoBuffer.append(
	...
	public String SagittariusInBhava1() {
		StringBuffer taurusInBhava1 = new StringBuffer();
	...
	public String CapricornInBhava1() {
		StringBuffer taurusInBhava1 = new StringBuffer();
	...
	public String AcquariusInBhava1() {
		StringBuffer taurusInBhava1 = new StringBuffer();
	...
	public String RashiSwamiIsExalted() {
		StringBuffer str = new StringBuffer();
		return str.toString();
	}

	public String RashiSwamiInOwnSign() {
		StringBuffer str = new StringBuffer();
		return str.toString();
	}

	public String RashiSwamiInGreatFriendSign() {
		StringBuffer str = new StringBuffer();
		return str.toString();
	}

	public String RashiSwamiInFriendSign() {
		StringBuffer str = new StringBuffer();
		return str.toString();
	}

	public String RashiSwamiInNuetralSign() {
		StringBuffer str = new StringBuffer();
		return str.toString();
	}

	public String RashiSwamiInEnemySign() {
		StringBuffer str = new StringBuffer();
		return str.toString();
	}

	public String RashiSwamiInGreatEnemySign() {
		StringBuffer str = new StringBuffer();
		return str.toString();
	}

	public String RashiSwamiInDebilitatedSign() {
		StringBuffer str = new StringBuffer();
		return str.toString();
	}
